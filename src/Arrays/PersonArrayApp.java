...
class PersonArray {
	...
	public Person find(String searchName){                              // find specified value
		...
		}  // end find()//-------------------------------------------------------------// put person into array
	...
	public boolean delete(String searchName){             // delete person from array
		...
		public void displayA() {
			...
			for(int j=0; j<nElems; j++)       // for each element,
				a[j].displayPerson();          // display it}//--------------------------------------------------------------// can’t find it
	}
...
public class PersonArrayApp{
	public static void main(String[] args) {
		...
		PersonArray arr;            // reference to array
		arr = new PersonArray(maxSize);  // create the array
		// insert 10 items
